      ...
      <section className="relative min-h-screen flex items-end pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-xl animate-fade-up">
            <p className="label-ys text-steel mb-6">ריהוט תעשייתי יוקרתי</p>
            <h1 className="font-cormorant text-5xl md:text-7xl font-light text-concrete leading-tight mb-6">
              עיצוב מנירוסטה.
              <br />
              <span className="text-steel">עבודת יד.</span>
            </h1>
            <p className="font-assistant text-base text-concrete/60 leading-relaxed mb-10 max-w-md">
              כל פריט מיוצר בישראל לפי מידות ודרישות אישיות. קולקציות 5mm ו-3mm נירוסטה, שולחנות, מדפים, כיסאות ועוד.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/products" className="btn-ys-solid px-8 py-3.5">
                לצפייה במוצרים
              </Link>
              <a
                ...
                className="btn-ys-outline px-8 py-3.5"
              >
                פנו אלינו
              </a>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce-scroll">
          <div className="w-px h-12 bg-gradient-to-b from-steel/60 to-transparent" />
        </div>
      </section>
