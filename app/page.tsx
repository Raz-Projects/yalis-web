  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col lg:flex-row">
        ...
        {/* Image — mobile: top half, desktop: left half full height */}
        <div className="relative w-full lg:w-1/2 h-[60vh] lg:h-screen lg:sticky lg:top-0 flex-shrink-0 overflow-hidden">
          <Image
            src="/hero.jpeg"
            alt="YALIS"
            fill
          ...
          />
          {/* subtle gradient at bottom for mobile readability */}
          <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-black/60 to-transparent lg:hidden" />
        </div>

        {/* Content — mobile: below image, desktop: right half centered */}
        <div className="flex-1 flex items-center justify-center lg:justify-start px-8 md:px-16 lg:px-20 py-20 lg:py-0 bg-black">
          <div className="max-w-lg w-full animate-fade-up">
            <p className="label-ys text-steel mb-8 tracking-[0.3em]">ריהוט תעשייתי יוקרתי</p>

            <h1 className="font-cormorant text-5xl md:text-6xl xl:text-7xl font-light text-concrete leading-[1.1] mb-8">
              עיצוב<br />
              מנירוסטה.<br />
              <span className="text-steel italic">עבודת יד.</span>
            </h1>

            <div className="ys-divider mb-8" />

            <p className="font-assistant text-base text-concrete/55 leading-relaxed mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/products" className="btn-ys-solid px-8 py-4 text-center">
                לצפייה במוצרים
              </Link>
              <a
                ...
                className="btn-ys-outline px-8 py-4 text-center"
              >
                פנו אלינו
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-8">
                ...
                <p className="steel-underline mt-4 text-sm text-concrete/70 group-hover:text-concrete transition-colors">
                  לצפייה בקולקציה
                </p>
              </div>
            </Link>
            ...
            {/* 3mm */}
            <Link
              href="/products?collection=3mm"
              className="group relative aspect-[4/3] rounded-2xl overflow-hidden bg-white/5"
            >
              <Image
                src="/products/p22.jpeg"
                alt="קולקציית 3mm"
                fill
                className="object-cover img-zoom"
                sizes="(max-width: 768px) 100vw, 50vw"
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link href="/products" className="btn-ys-ghost text-sm hidden md:flex">
              כל המוצרים ←
            </Link>
          </div>
          ...
          <div className="mt-12 text-center md:hidden">
            <Link href="/products" className="btn-ys-outline px-8 py-3">
              כל המוצרים
            </Link>
          </div>
        </div>
      ...
      <section id="contact" className="py-24 px-6 bg-black">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="font-assistant text-base text-concrete/60 max-w-lg mx-auto">
            כל מוצר יכול להיות מותאם לגודל, לחומר ולגימור שאתם רוצים. פנו אלינו ישירות ונבנה ביחד את מה שאתם צריכים.
          </p>
          <a
            href="https://wa.me/972528448870"
            target="_blank"
