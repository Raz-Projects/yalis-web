  ...
  return (
    <footer className="border-t border-white/10 bg-onyx-dark mt-24">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Links */}
        <div className="space-y-4">
          <h4 className="font-cormorant text-base text-concrete font-medium tracking-wide">ניווט</h4>
        ...
        {/* Contact */}
        <div className="space-y-4">
          <h4 className="font-cormorant text-base text-concrete font-medium tracking-wide">צור קשר</h4>
