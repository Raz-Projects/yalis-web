...
export const products: Product[] = [
...

  {
    ...
    images: ["/products/p04.jpeg", "/products/p05.jpeg"],
    priceFrom: 2800,
    customizable: true,
  },

  {
    ...
    descriptionHe:
      "שידת צד מנירוסטה 5 מ\"מ — נירוסטה מקורית ללא גימור שחור. אחסון פנימי מעוצב, שמיש וחזותי במידה שווה.",
    material: "נירוסטה 5 מ\"מ",
...

  {
    ...
    descriptionHe:
      "מנורה תלויה מנירוסטה 3 מ\"מ — קו ישר ואחיד. אור פנימי ישיר או עקיף לפי הפניה. ניתן לאורכים שונים ולכמות מקורות אור שונה.",
  ...
  {
    slug: "shelves-wood-cube-supports",
    nameHe: "מדפים עם תמוכות קוביות עץ",
    nameEn: "Shelves — Wood Cube Supports",
    category: "shelving",
    categoryHe: "מדפים ואחסון",
    collection: "3mm",
    taglineHe: "פלדה ועץ — כוח ויופי יחד",
    descriptionHe:
      "מדפי נירוסטה 3 מ\"מ הנשענים על תמוכות קוביות מעץ מלא. שילוב ייחודי של חמימות העץ עם הנוקשות של הנירוסטה. ניתן להתאים מספר מדפים, גובה וסוג עץ.",
